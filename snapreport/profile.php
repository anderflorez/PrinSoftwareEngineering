				...
				<div class="row text-center">
					...
					<div class="col-md-4 col-sm-4">
						<div class="services animate-box">
							...
							<a href="submitreport.php">Create Report</a>
							<p>Instantaneously report problems in need of fixing, along with corresponding photos</p>
						</div>
					</div>
					<div class="col-md-4 col-sm-4">
						<div class="services animate-box">
						...
						<a href="createevent.php">Create Event</a>
							<p>Promote Your event here on SnapReport and reach undreds of users! </p>
						</div>
					</div>
