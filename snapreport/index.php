...
-->
		...
		<div class="fh5co-hero">
			...
			<div class="fh5co-cover text-center" data-stellar-background-ratio="0.5" style= "background-image: url(images/cover_bg_1.jpg);" align="center">
				<div class="desc animate-box">
					<h2>SnapReport</h2>
					
					<p><a class="btn btn-primary btn-lg btn-learn" href="login.php">Login</a> 
                        <a class="btn btn-primary btn-lg btn-learn" href="signup.php"><i class="icon-play"></i> Sign Up</a></p>
				</div>
			</div>
				...
				<div class="row text-center">
					...
					<div class="col-md-4 col-sm-4">
						<div class="services animate-box">
							...
							<p>Whether you are creating a post on your phone, computer or tablet, Snap Report Works great in any platform </p>
						</div>
					</div>
					<div class="col-md-4 col-sm-4">
						<div class="services animate-box">
							<span><i class="icon-tools"></i></span>
							<h3>Creat a Post or Event</h3>
							<p>Instantaneously report problems in need of fixing, as well as events, along with corresponding photos</p>
						</div>
					</div>
					...
					<div class="col-md-4 col-sm-4">
						<div class="services animate-box">
							...
							<h3>Post Search</h3>
							<p>Easily search among the different categories of reported problems in order to efficiently dispatch the correct personnel to fix each issue.</p>
						</div>
					</div>
