...
<!-- Mirrored from vendroid.venmond.com/pages-user-profile.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 22 Nov 2016 21:57:30 GMT -->
...
<div class="content">
  <div class="container">
	...
	<div class="navbar-menu clearfix">
    	...
    	<h3 class="menu-title hide-nav-medium hide-nav-small">SnapReport</h3>
        <div class="vd_menu">
        	 <ul>
    <li>
...
<!-- Head menu search form ends -->         </div>             
  ...
  <ul class="nav nav-tabs widget">
    ...
    <li> <a data-toggle="tab" href="#projects-tab"> Reports <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>    
    <li> <a data-toggle="tab" href="#photos-tab"> Events <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>
...
<div class="vd_info tr"> <a class="btn vd_btn btn-xs vd_bg-yellow" href="edit-profile.html"> <i class="fa fa-pencil append-icon"></i> Edit </a> </div>      
        <h3 class="mgbt-xs-15 mgtp-10 font-semibold"><i class="icon-user mgr-10 profile-icon"></i> ABOUT ME</h3>
        <div class="row">
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-sm-7 mgbt-xs-20">
            <h3 class="mgbt-xs-15 font-semibold"><i class="fa fa-file-text-o mgr-10 profile-icon"></i> Submitted Reports</h3>
            <div class="content-list content-menu">
              <ul class="list-wrapper">
          ...
          <div class="col-sm-5">
            <h3 class="mgbt-xs-15 font-semibold"><i class="fa fa-trophy mgr-10 profile-icon"></i> Submitted Events</h3>
            <div class="content-list content-menu">
              <ul class="list-wrapper">
...
<!-- Mirrored from vendroid.venmond.com/pages-user-profile.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 22 Nov 2016 22:05:03 GMT -->
</html>